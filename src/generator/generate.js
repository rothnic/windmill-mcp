...
// Resolve paths relative to project root (two levels up from src/generator/)
const projectRoot = path.resolve(__dirname, "..", "..");
const CACHE_PATH = path.resolve(projectRoot, config.openapi.localCache);
const OUTPUT_DIR = path.resolve(projectRoot, config.generator.outputDir);
